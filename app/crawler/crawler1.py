    ...
    while page <= MAX_PAGE:
        ...
        for _ in range(PAGE_BATCH_SIZE):
            if page % FETCHING_PAGE_BATCH == 0:
                print(f"Fetching page {page} by crawler1", flush=True)
...
if __name__ == "__main__":
    print_with_timestamp("Starting Market Updater for pages 1 to 200 by crawler1.")
    sys.stdout.flush()
    fetch_market_data()
    print_with_timestamp("Market update finished for pages 1 to 200 by crawler1.")
