...
class Product {
    ...
    constructor(itemname,typeid,iconurl,origin_quantity,quantity,level,row,product_node){
        ...
        //Values of material array will set by setMaterials() method
...
*/
    ...
    toggleVisibility(tsize){
        if(tsize===undefined){
            tsize=(this.visibility==1)?1:0;
        }
